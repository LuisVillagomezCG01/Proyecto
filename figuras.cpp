...
void CFiguras::prisma1(GLuint text)  //Funcion creacion prisma
{
	GLfloat vertice[8][3] = {
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0f, 1.00f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0, 1.0f); glVertex3fv(vertice[3]);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, text);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Top-la de arriba
	glNormal3f(0.0f, 1.0f, 0.0f);
...
void CFiguras::prisma3(GLuint text, GLuint text2, GLuint text3) {
...
void CFiguras::prisma4(float altura, float largo, float profundidad, GLuint text) {
...
void CFiguras::prisma4a(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
